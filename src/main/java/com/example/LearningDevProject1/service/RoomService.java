 ...
 *		создаётся {@link com.example.LearningDevProject1.entity.Room} с типом private,
 *		в {@link com.example.LearningDevProject1.entity.RoomMembers} добавляется запись создателя приглашения и
 *		запись приглашённого в состоянии ожидания
 *		{@link com.example.LearningDevProject1.entity.RoomMembers#setInviteStatus(boolean)} = false,
